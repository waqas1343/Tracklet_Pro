            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  for (final o
                      in context.watch<HomeProvider>().pendingOrders) ...[
                    NewOrderCard(
                      ...
                      onApprove: () async {
                        final rate = context.read<RateProvider>().todayRate;
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              'Order approved and moved to Completed',
                            ),
                          ),
                        );
                      },
                      onCancel: () async {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              'Order cancelled and moved to Cancelled',
                            ),
                          ),
                        );
                      },
