          ...
          child: Row(
            ...
            children: [
              Padding(
                ...
                child: Text('Cancelled', style: Theme.of(context).textTheme.labelLarge?.copyWith(color: textColor, fontSize: 14, fontWeight: FontWeight.w500) ?? TextStyle(color: textColor, fontSize: 14, fontWeight: FontWeight.w500)),
              ),
              Container(
                width: 37,
                height: 37,
